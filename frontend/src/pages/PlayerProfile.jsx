...
import {
  ...
  IconCheck, IconX, IconInfoCircle, IconNetwork, IconWorldWww, 
  IconAlertTriangle, IconEye
      ...
      <Tabs defaultValue="overview">
          ...
          <SimpleGrid cols={3} breakpoints={[{ maxWidth: 'md', cols: 1 }]}>
            ...
            {profileData.ipTracking && (
              <Card shadow="sm" padding="lg" radius="md" withBorder>
                ...
                {profileData.ipTracking.uniqueIPCount > 5 && (
                  <Alert icon={<IconAlertTriangle size={16} />} color="orange" title="Risk" mt="sm">
                    Bu oyuncu {profileData.ipTracking.uniqueIPCount} farklı IP kullanmış. Çoklu hesap riski!
                  </Alert>
                )}
              </Card>
            )}
        ...
        <Tabs.Panel value="ip" pt="md">
          <Card shadow="sm" padding="lg" radius="md" withBorder>
            <Stack spacing="md">
              <Group position="apart">
                <Text size="lg" weight={600}>🌐 IP Adresi Geçmişi</Text>
